...
static const variant_info_t sweetin_info = {
    ...
    .marketname = "Redmi Note 10 Pro",
    .model = "M2101K6I",
    .build_fingerprint = "Redmi/sweetin/sweetin:12/RKQ1.210614.002/V13.0.3.0.SKFINXM:user/release-keys",
...
static const variant_info_t sweetinpro_info = {
    ...
    .model = "M2101K6I",
    .build_fingerprint = "Redmi/sweetinpro/sweetin:12/RKQ1.210614.002/V13.0.3.0.SKFINXM:user/release-keys",
